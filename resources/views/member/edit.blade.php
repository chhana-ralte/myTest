...
-->
          ...
          <div class="mt-2">
            <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
              <input 
                ...
                name="name" 
                id="name" 
                class="block flex-1 border-0 py-1.5 pl-2 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" 
                placeholder="Name"
                value = '{{ $member->name }}'
                >
            </div>
  ...
  <div class="mt-6 flex items-center justify-end gap-x-6">
    <x-button href="/member/{{ $member->id }}">Cancel</x-button>
